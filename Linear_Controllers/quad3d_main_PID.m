...
<<<<<<< HEAD:quad3d_main_PID.m
x_ref = [-8, 0, 0, 0, 0, 0, q0_f, q1_f, q2_f, q3_f]'; % r_xy = [-4,4] m
=======
x_ref = [25, 0, 0, 0, 0, 0, q0_f, q1_f, q2_f, q3_f]'; % r_xy = [-25,25] m
>>>>>>> master:Linear_Controllers/quad3d_main_PID.m
...
=======
    v_ref = [1*ones(1,numPts); 0*ones(1,numPts)];
>>>>>>> master:Linear_Controllers/quad3d_main_PID.m
else
...
=======
        ie_pos(1:2,i) = ie_pos(1:2,i-1) + e_pos(1:2,i-1)*dt;
>>>>>>> master:Linear_Controllers/quad3d_main_PID.m
...
=======
        phi_theta_ref(:,i) = [sin(psi_f), -cos(psi_f); cos(psi_f), sin(psi_f)]*a_ref(:,i)/data.g;
>>>>>>> master:Linear_Controllers/quad3d_main_PID.m
        % --- References: 
...
<<<<<<< HEAD:quad3d_main_PID.m
    ...
    plot(t(i), theta, 'bo')
=======
    plot(t(i), theta_ref_i*180/pi, 'r+')
    hold on;
    plot(t(i), phi_theta_ref(2,i)*180/pi, 'gx');
    hold on;
    plot(t(i), theta*180/pi, 'bo')
>>>>>>> master:Linear_Controllers/quad3d_main_PID.m
    hold on;
...
hold on;
if vel_loop
    plot(t,phi_theta_ref(1,:)*180/pi, 'LineStyle', '-', 'Color', 'g');
    hold on
...
hold on;
if vel_loop
    plot(t,phi_theta_ref(2,:)*180/pi, 'LineStyle', '-', 'Color', 'g');
    hold on
